...
class NineGameBase(Widget):
    ...
    def mov_player(self, dt):
        ...
        #self.collision_list.get(self.player)
        #if self.player.collide_widget(self.collision_list.get(self.player)):
            #print("ok")
        #elif self.player.vel_player_y != 0:
            #for blok_l in self.blok_list.keys():
                
                #if self.player.collide_widget(blok_l) and self.collision_list.get(self.player) != blok_l:
            ...
            #self.player.vel_player = (0, 0)
            #print("ok")
        #if self.player.collide_widget(self.collision_list.get(self.player)) and self.player.vel_player_y == 0:
            #self.player.vel_player = (0, -2)
            #self.collision_list.get(self.player)
